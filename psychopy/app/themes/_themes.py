...
class PsychopyTheme(pygments.style.Style):
    ...
    def __init__(self, name):
        ...
        with open(Path(prefs.paths['themes']) / (name + ".json")) as f:
    ...
    def apply(self, target):
        ...
        """
        # Make sure we're getting an stc control
...
class ThemeMixin:
    ...
    mode = 'light'
    icons = 'light'
    codeColors = PsychopyTheme(codetheme)
    appColors = {}
    appIcons = {'components': {},
                'resources': {}}
    ...
    def loadThemeSpec(self, themeName):
        ...
        ThemeMixin.codeColors = PsychopyTheme(themeName)
    ...
    def _applyAppTheme(self, target=None):
        ...
        def applyToCodeEditor(target):
            ThemeMixin.codeColors.apply(target)
            # Set wrap point
