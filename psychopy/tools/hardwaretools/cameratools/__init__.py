...
class CameraInfo:
    ...
    def __init__(self,
                 index=-1,
                 name=constants.CAMERA_NULL_VALUE,
                 frameSize=(-1, -1),
                 frameRate=(-1, -1),
                 pixelFormat=constants.CAMERA_UNKNOWN_VALUE,
                 codecFormat=constants.CAMERA_UNKNOWN_VALUE,
                 cameraLib=constants.CAMERA_NULL_VALUE,
                 cameraAPI=constants.CAMERA_API_NULL):
    ...
    for device in allDevices:
        ...
        for _format in devFormats:
            ...
            thisCamInfo = CameraInfo(
                ...
                codecFormat=constants.CAMERA_NULL_VALUE,
                frameSize=(int(frameWidth), int(frameHeight)),
                frameRate=frameRateMax,
                cameraAPI=constants.CAMERA_API_AVFOUNDATION
            )
    ...
    for devURI in videoDevs.keys():
        ...
        for _format in videoDevs[devURI]:
            ...
            temp = CameraInfo(
                ...
                frameSize=frameSize,
                frameRate=frameRateMax,
                cameraAPI=constants.CAMERA_API_DIRECTSHOW
            )
